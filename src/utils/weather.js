...
const GetGeocode = (city,callback) =>{
    var url_ = 'http://api.weatherstack.com/current?access_key=<api key>&query='+ city
...
const GetForecast =  (latitude,longitude,callback) => {
    ...
    var url_ = 'http://api.weatherstack.com/current?access_key=<api key>&query='+ latitude +','+ longitude
